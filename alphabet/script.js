...
function checkMatch(card1, card2) {
    const letter1 = card1.dataset.letter.toUpperCase();
    const letter2 = card2.dataset.letter.toUpperCase();
...
function useHint() {
    ...
    const unflippedCards = Array.from(document.querySelectorAll('.letter-card:not(.flipped):not(.matched)'));
